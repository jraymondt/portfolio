      ...
      <main>
        <div class="wrapper">
          ...
          <div class="dialog">
            ...
            <br>
            <p>Contact me via the form below or 
              <br>
              <br>
               <a href="mailto:james@jraymondt.com"><button class="nb-button orange rounded"> email </button></a></p>
          </div>
            <form class="dialog" action="/action_page.php">
              ...
              <select id="country" name="country">
                ...
                <option value="usa">Space the final frontier</option>
              </select>
